    ...
    slotProps={{
      outlineColor: (theme) =>
        `linear-gradient(135deg, ${varAlpha(
          theme.vars.palette.secondary.lightChannel,
          0.08
        )} 50%, ${varAlpha(theme.vars.palette.error.mainChannel, 0.24)})`,
      primaryBorder: {
        size: 60,
        width: borderWidth,
        sx: (theme) => ({
  ...
  return (
    <>
        ...
        slotProps={{
          outlineColor: (theme) =>
            `linear-gradient(135deg, ${varAlpha(
              theme.vars.palette.secondary.lightChannel,
              0.08
            )} 50%, ${varAlpha(theme.vars.palette.secondary.mainChannel, 0.24)})`,
          primaryBorder: {
            width: '4px',
            size: 60,
            sx: (theme) => ({
      ...
      <AnimateBorder
        ...
        slotProps={{
          outlineColor: (theme) =>
            `linear-gradient(135deg, ${hexAlpha(
              '#087f5b',
              0.08
            )} 50%, ${hexAlpha('#e67700', 0.24)})`,
          primaryBorder: {
            size: 60,
            width: '4px',
            sx: { color: '#087f5b' },
        ...
        slotProps={{
          outlineColor: (theme) =>
            `linear-gradient(135deg, ${varAlpha(
              ...
              0.08
            )} 50%, ${varAlpha(theme.vars.palette.warning.mainChannel, 0.24)})`,
          primaryBorder: {
            size: 100,
            width: '3px',
            sx: (theme) => ({
