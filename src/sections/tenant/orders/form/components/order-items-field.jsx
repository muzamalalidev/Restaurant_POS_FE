...
/**
 * Order Items Field Component
 * 
 * Manages an array of order items with add/remove, validation, and subtotal calculation.
 */
export function OrderItemsField({ name = 'items', itemOptions = [] }) {
